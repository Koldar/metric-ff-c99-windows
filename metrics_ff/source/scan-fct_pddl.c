...
{
       0,   188,   188,   191,   198,   197,   213,   223,   234,   237,
     239,   241,   243,   245,   251,   261,   260,   275,   274,   288,
     313,   321,   329,   337,   345,   353,   366,   372,   378,   384,
     394,   409,   432,   436,   455,   460,   470,   475,   492,   520,
     528,   537,   543,   550,   557,   564,   575,   583,   592,   598,
     605,   612,   619,   630,   636,   645,   652,   665,   669,   680,
     686,   696,   703,   716,   718,   727,   738,   758,   760,   769,
     780,   801,   826,   836,   846,   858,   860
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4:
#line 198 "../scan-fct_pddl.y"
    { 
  fcterr( PROBNAME_EXPECTED, NULL ); 
}
#line 1480 "c/scan-fct_pddl.c"
    break;
...
#line 1536 "c/scan-fct_pddl.c"
    break;

  case 17:
#line 275 "../scan-fct_pddl.y"
    { 
  fcterr( GOALDEF, NULL ); 
}
#line 1544 "c/scan-fct_pddl.c"
    break;
...
#line 1553 "c/scan-fct_pddl.c"
    break;

  case 19:
#line 289 "../scan-fct_pddl.y"
    {
...
#line 1624 "c/scan-fct_pddl.c"
    break;

  case 25:
#line 354 "../scan-fct_pddl.y"
    { 
  if ( sis_negated ) {
...
#line 1729 "c/scan-fct_pddl.c"
    break;

  case 34:
#line 456 "../scan-fct_pddl.y"
    {
  (yyval.pPlNode) = (yyvsp[0].pPlNode);
}
#line 1737 "c/scan-fct_pddl.c"
    break;
...
#line 1927 "c/scan-fct_pddl.c"
    break;

  case 52:
#line 620 "../scan-fct_pddl.y"
    {
  (yyval.pParseExpNode) = new_ParseExpNode( DI );
  (yyval.pParseExpNode)->leftson = (yyvsp[-2].pParseExpNode);
  (yyval.pParseExpNode)->rightson = (yyvsp[-1].pParseExpNode);
}
#line 1937 "c/scan-fct_pddl.c"
    break;
...
#line 1946 "c/scan-fct_pddl.c"
    break;

  case 54:
#line 637 "../scan-fct_pddl.y"
    {
  (yyval.pTokenList) = (yyvsp[0].pTokenList);
}
#line 1954 "c/scan-fct_pddl.c"
    break;
...
#line 1975 "c/scan-fct_pddl.c"
    break;

  case 57:
#line 665 "../scan-fct_pddl.y"
    {
  (yyval.pTokenList) = NULL;
}
#line 1983 "c/scan-fct_pddl.c"
    break;
...
#line 2032 "c/scan-fct_pddl.c"
    break;

  case 63:
#line 716 "../scan-fct_pddl.y"
    { (yyval.pTypedList) = NULL; }
#line 2038 "c/scan-fct_pddl.c"
    break;
...
#line 2082 "c/scan-fct_pddl.c"
    break;

  case 67:
#line 758 "../scan-fct_pddl.y"
    { (yyval.pTypedList) = NULL; }
#line 2088 "c/scan-fct_pddl.c"
    break;
...
#line 2114 "c/scan-fct_pddl.c"
    break;

  case 70:
#line 781 "../scan-fct_pddl.y"
    {
  (yyval.pTypedList) = new_TypedList();
  (yyval.pTypedList)->name = new_Token( strlen((yyvsp[-1].string))+1 );
  strcpy( (yyval.pTypedList)->name, (yyvsp[-1].string) );
...
#line 2132 "c/scan-fct_pddl.c"
    break;

  case 71:
#line 802 "../scan-fct_pddl.y"
    { 
  (yyval.pstring) = new_Token(strlen((yyvsp[0].string)) + 1);
  strcpy((yyval.pstring), (yyvsp[0].string));
}
#line 2141 "c/scan-fct_pddl.c"
    break;
...
#line 2154 "c/scan-fct_pddl.c"
    break;

  case 73:
#line 837 "../scan-fct_pddl.y"
    {
  (yyval.pPlNode) = new_PlNode(ATOM);
  (yyval.pPlNode)->atom = (yyvsp[0].pTokenList);
}
#line 2163 "c/scan-fct_pddl.c"
    break;
...
#line 2173 "c/scan-fct_pddl.c"
    break;

  case 75:
#line 858 "../scan-fct_pddl.y"
    { (yyval.pTokenList) = NULL; }
#line 2179 "c/scan-fct_pddl.c"
    break;
...
#line 2190 "c/scan-fct_pddl.c"
    break;


#line 2194 "c/scan-fct_pddl.c"
